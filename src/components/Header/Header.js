...
const Header = () => {
  ...
  return (
    <div className='flex flex-row justify-between px-8 p-3 bg-white md:bg-[#f3f1ef]  items-center rounded-tr-3xl'>
      <div className='flex flex-row gap-2 items-center relative right-4 md:right-0'>
      ...
      <div className='flex flex-row justify-center items-center gap-10'>
         <div className='flex flex-row items-center  justify-between md:justify-center gap-4 md:gap-10 rounded-r-3xl '>
            ...
            <img alt=' person' src='/public/logos/New folder/avt-5.jpg' className='h-8 w-8 rounded-full ' />

         </div>
         <div className='hidden md:flex flex-row items-center justify-center gap-8 ml-8 '>
